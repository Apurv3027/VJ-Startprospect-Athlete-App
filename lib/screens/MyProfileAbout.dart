...
class MyProfileAbout extends StatefulWidget {
  const MyProfileAbout({Key? key}) : super(key: key);

  @override
  _MyProfileAboutState createState() => _MyProfileAboutState();
}

class _MyProfileAboutState extends State<MyProfileAbout>{
  @override
          ...
          child: Column(
            children: [
              Center(
                child: Column(
                  children: [
                    Image.asset('assets/image/bottom2.png'),
                    Text(
                    ...
                    Text(
                      'The higher your score, the higher you appear in college coachs searches',
